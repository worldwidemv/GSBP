...
#define GSBP_SETUP__INTERFACE_UART_USED			1		// 0= not active; 1= is active
#define GSBP_SETUP__INTERFACE_USB_USED			0		// 0= not active; 1= is active
...
#define GSBP_SETUP__MAX_PAYLOAD_SIZE_TX         1000	// What is the largest payload/package you expect to send?
...
#define GSBP_DEBUG_UART                     	huart1	// comment out, if no debug UART is used!
#define GSBP_DEBUG_UART_USES_DMA				1		// send debug msg blocking (=0; via CPU) or non-blocking (=1; via DMA (needs to be configured))
