 ...
 *   File:    GSBP_DevDummy.hpp -> Header file for the communication interface class
 *   Version: 2 (09.2020)
 *
...
namespace ns_GSBP_DD_01 {
    ...
    public:
        ...
        struct gsbpConfiguration_t {
        	...
        	std::function<bool(GSBP_DD::rxPackage_t*, uint64_t)> PackageHandler;
        ...
        /* Public Functions */
        GSBP_DD(void);
        GSBP_DD(char* DeviceID);
        GSBP_DD(char* DeviceID, char* DeviceFileName, uint16_t DeviceClass, gsbpConfiguration_t Config);
        ~GSBP_DD(void);
